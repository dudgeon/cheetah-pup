...
# Custom servo-bus / power / sensor breakout board (carries the IMU), hung from the lid underside
# over the front abad servos: 40 x 60 mm, low profile (board + components downward, 8 mm envelope).
PCB = Component("Custom bus/power/sensor PCB", (0.040, 0.060, 0.008), 0.025)
